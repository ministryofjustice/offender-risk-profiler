...
aws --endpoint-url=http://localhost:4572 s3 cp buckets/viper/VIPER-Dummy.csv s3://testbucket/viper/VIPER-Dummy.csv
aws --endpoint-url=http://localhost:4572 s3 cp buckets/ocgm/OCGM-Dummy.csv s3://testbucket/ocgm/OCGM-Dummy.csv
aws --endpoint-url=http://localhost:4572 s3 cp buckets/ocg/OCG-Dummy.csv s3://testbucket/ocg/OCG-Dummy.csv
aws --endpoint-url=http://localhost:4572 s3 cp buckets/pras/PRAS-Dummy.csv s3://testbucket/pras/PRAS-Dummy.csv
