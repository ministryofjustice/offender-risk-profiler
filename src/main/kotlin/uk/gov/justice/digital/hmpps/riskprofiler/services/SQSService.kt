...
class SQSService(
  ...
  init {
    val riskProfileChangeQueue = hmppsQueueService.findByQueueId("Digital-Prison-Services-dev-risk_profiler_change") ?: throw MissingQueueException("Could not find queue riskprofilechangequeue")
